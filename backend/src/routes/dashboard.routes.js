...
const {
  ...
  getExecutiveOverview, getAttendanceAnomalies, listAnnouncements, createAnnouncement, deleteAnnouncement, getCalendarEvents, createCalendarEvent,
...
router.get("/inventory-activity", requireInventoryAccess, getInventoryActivitySeries)
...
router.post("/events", requireManagement, createCalendarEvent)
